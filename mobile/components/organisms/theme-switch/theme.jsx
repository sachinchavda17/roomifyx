...
import { ThemeMode, AnimationType } from "./types";
import {
...
export const ThemeSwitcher = forwardRef(
  (
    ...
    const animateThemeChange = async (touchX, touchY) => {
      ...
      // Skia's makeImageFromView is broken on New Architecture (Fabric).
      // Skip the snapshot overlay entirely — theme switches instantly instead.
    ...
    return (
      <View style={[styles.container, style]} ref={viewRef} collapsable={false}>
        ...
        {overlay && typeof overlay.width === "function" && overlay.width() > 0 && (
