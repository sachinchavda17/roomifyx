...
import Animated, { useSharedValue, useAnimatedStyle, withSpring, withTiming, useAnimatedProps, withSequence, Easing } from "react-native-reanimated"
...
const SegmentedControl = ({
  ...
  const tabTranslate = useSharedValue(currentIndex * translateValue)
  ...
  const triggerTapScale = useCallback(() => {
    ...
    activeScale.value = withSequence(withTiming(1.3, { duration: 350 }), withSpring(1, { stiffness: 10, damping: 5, mass: 0.8 }))
  }, [disableScaleEffect])
...
const AnimatedDivider = ({ currentIndex, dividerIndex, color }) => {
